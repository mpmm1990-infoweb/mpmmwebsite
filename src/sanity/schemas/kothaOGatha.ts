...
export const kothaOGatha = defineType({
  ...
  type: "document",
  description:
    "এখানে সদস্যদের কবিতা, গল্প, স্মৃতিচারণ বা অন্যান্য সাহিত্যকর্ম যোগ করুন। এগুলো ওয়েবসাইটের 'কথা ও গাথা' সেকশনে মারকি (স্ক্রলিং) আকারে দেখাবে এবং ক্লিক করলে পপআপে বিস্তারিত পড়া যাবে।",
  fields: [
    defineField({
      name: "name",
    ...
    defineField({
      name: "title",
      title: "লেখার মূল শিরোনাম (Title — যে ভাষায় লেখা হয়েছে)",
      type: "string",
      description:
        "কবিতা, গল্প বা স্মৃতিচারণের মূল শিরোনাম (লেখক যে ভাষায় লিখেছেন ঠিক সেভাবেই একক ফিল্ডে দিন)।",
      validation: (Rule) => Rule.required(),
    }),
    defineField({
      name: "content",
      title: "সম্পূর্ণ মূল লেখা (Full Content — কবিতা/গল্প/স্মৃতিকথা)",
      type: "text",
      rows: 10,
      description:
        "কবিতা, গল্প বা স্মৃতিচারণের সম্পূর্ণ মূল বিষয়বস্তু (লেখক যে ভাষায় লিখেছেন ঠিক সেভাবেই একক টেক্সট ফিল্ডে দিন)। পপআপে এটি হুবহু দেখাবে।",
      validation: (Rule) => Rule.required(),
    }),
    defineField({
      name: "photo",
